...
import { faHome, faArchive, faTrash, faClone, faFolder } from '@fortawesome/free-solid-svg-icons';
...
const Burger = () => {
    ...
    return (
        <div className={`Burger ` }>
            ...
            <Link to="/libelle"><FontAwesomeIcon className="Buger_menu_icon" icon={faFolder}/><span>Gérer les libellés</span></Link>
